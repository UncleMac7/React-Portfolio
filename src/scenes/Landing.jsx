            ...
            <div 
             ...
             >
              <img 
                ...
                max-w-[300px] md:max-w-[500px] rounded-t-[300px]"
                src="assets/me.jpeg"
              />
            </div>
        ): (
                ...
                >
                    <p className="text-6xl font-playfair z-10 text-center md:text-start">
                        ...
                        <span className="xs:relative xs:text-deep-blue xs:font-semibold z-20
                            xs:before:content-brush before:absolute before:-left-[10px]
                            before:-top-[70px] before:z-[-1]">
                            Machete
                        </span>
                    </p>

                    <p className="mt-10 mb-7 text-4md font-playfair text-center md:text-start">
                        Hey there, I'm a FULLSTACK Software Engineer dedicated to building projects that make
                        tomorrow better.
                    </p>
                </motion.div>
